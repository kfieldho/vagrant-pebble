...
wget -q -a /vagrant/peeble.log https://s3.amazonaws.com/assets.getpebble.com/pebble-tool/pebble-sdk-4.5-linux64.tar.bz2
...
echo "---------------------------------------------------"
echo "export PATH=/home/vagrant/pebble-dev/pebble-sdk-4.5-linux64/bin:\$PATH" >> /home/vagrant/.profile
